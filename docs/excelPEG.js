...
formula = lexpression:expression {return lexpression;}
expression = "(" lexpression:expression ")" {return lexpression;} 
			/ constant
...
logical_constant = "FALSE" 
			/ "TRUE";
numerical_constant = whole_number_part full_stop ? exponent_part ?
...
character ::= #x9 
		...
		| [#xE000 - #xFFFD] 	
		| [#x10000 - #x10FFFF]
		 (* any Unicode character, excluding surrogate blocks, FFE, and FFFF*)
*/
character = [a-z] / [A-Z];
...
cell_reference = name
				...
				/ work_sheet_prefix ? A1_reference ":" A1_reference
				/ work_sheet_prefix ? R1C1_reference
				/ work_sheet_prefix ? R1C1_reference ":" R1C1_reference;
...
predefined_function_name = "ABS" / "ACOS" ; /*All the functions in the table 18.17.7 but I don't think we need this distinction*/
prefixed_function_name = "ISO." predefined_function_name 
						/ "ECMA." predefined_function_name ;
