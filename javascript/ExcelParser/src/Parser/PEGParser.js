        ...
        var result = {
            ...
            parse: function(input, startRule) {
                ...
                function parse_ArrayConstant() {
                    ...
                    if (result0 !== null) {
                        result0 = (function(offset, c) { if(c.length==0){ return null;}else{norm=c[0].length; for(i=1; i<c.length; i++){if(c[i].length!==norm)return null;} } return new AST.ConstantArray(null, c);})(pos0, result0[1]);
                    }
                    if (result0 === null) {
                        pos = pos0;
                    }
