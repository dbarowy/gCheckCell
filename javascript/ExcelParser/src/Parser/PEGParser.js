define(["Parser/PEG", "AST/AST", "FSharp/FSharp"], function (PEG, AST, FSharp) {
            ...
            parse: function (input, startRule) {
                ...
                function parse_Int32() {
                    ...
                    if (result0 !== null) {
                        ...
                        if (result1 !== null) {
                            result1 = (function (offset, oct) {
                                var res = [];
                                for (var i = 0; i < oct.length; i++) if (oct[i] instanceof Array) res.push(oct[i].join("")); else res.push(oct[i]);
                                var a = res.join("");
                                return parseInt(a.slice(0, 1) + a.slice(2), 8);
                            })(pos2, result1);
                        }
                        if (result1 === null) {
                            pos = pos2;
                        ...
                        if (result1 === null) {
                            ...
                            if (result1 !== null) {
                                result1 = (function (offset, b) {
                                    var res = [];
                                    for (var i = 0; i < b.length; i++) if (b[i] instanceof Array) res.push(b[i].join("")); else res.push(b[i]);
                                    var a = res.join("");
                                    return parseInt(a.slice(0, 1) + a.slice(2), 2);
                                })(pos2, result1);
                            }
                            if (result1 === null) {
                                pos = pos2;
                            ...
                            if (result1 === null) {
                                ...
                                if (result1 !== null) {
                                    result1 = (function (offset, h) {
                                        var res = [];
                                        for (var i = 0; i < h.length; i++)
                                            if (h[i] instanceof Array) res.push(h[i].join("")); else res.push(h[i]);
                                        var a = res.join("");
                ...
                function parse_WorksheetNameQuoted() {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset, r) {
                            var res = [];
                            for (var i = 0; i < r.length; i++) res.push(r[i].join(""));
                            return res.join("");
                        })(pos0, result0[1]);
                    }
                    if (result0 === null) {
                ...
                function parse_NamedReference() {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset, c, s) {
                            return new AST.ReferenceNamed(null, c + s);
                        })(pos0, result0[0], result0[1]);
                    }
                    if (result0 === null) {
                        pos = pos0;
                ...
                function parse_StringReference() {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset, r) {
                            var res = [];
                            for (var i = 0; i < r.length; i++) res.push(r[i].join(""));
                            return new AST.ReferenceString(null, res.join(""));
                        })(pos0, result0[1]);
                    }
                    if (result0 === null) {
                        pos = pos0;
                ...
                function parse_ConstantReference() {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset, r) {
                            return new AST.ReferenceConstant(null, r);
                        })(pos0, result0);
                    }
                    if (result0 === null) {
                        pos = pos0;
                ...
                function parse_BinOpLong() {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset, op, exp) {
                            return {operator: op, expression: exp};
                        })(pos0, result0[0], result0[1]);
                    }
                    if (result0 === null) {
                        pos = pos0;
                ...
                function parse_BinOpExpr() {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset, exp, lhs) {
                            return new AST.BinOpExpr(lhs.operator, exp, lhs.expression);
                        })(pos0, result0[0], result0[1]);
                    }
                    if (result0 === null) {
                        pos = pos0;
                ...
                function parse_ArgumentList() {
                    ...
                    if (result0 !== null) {
                        result0 = (function (offset, hd, tl) {
                            var a = [hd];
                            for (i = 0; i < tl.length; i++) a.push(tl[i][1]);
                            return a;
