...
import PEGParser = require("PEGParser");
import XLogger = require("../XClasses/XLogger");
import XTypes = require("../XClasses/XTypes");
import XTypedValue = require("../XClasses/XTypedValue");
 ...
 * @returns {string}
 */
export function no_ws(/*string*/str) {
 ...
 */
export function getAddress(/*string*/str, /*Workbook*/wb, /*Worksheet*/ws) {
    var address;
    try {
 ...
 */
export function getRange(/*string*/str) {
    try {
 ...
 * @returns {*}
 */
export function getAddressReference(/*string*/str, /*XWorkbook*/wb, /*XWorksheet*/ws) {
    var reference;
    try {
 ...
 * @constructor
 */
export function getReference(/*string*/str, /*Workbook*/wb, /*Worksheet*/ws) {
    var reference;
    try {
 ...
 * @constructor
 */
export function parseFormula(/*string*/str, /*Workbook*/wb, /*Worksheet*/ws) {
    var formula;
    try {
 ...
 * @returns {*}
 */
export function extractFunctionName(expr) {
 ...
 * @returns {*}
 */
export function extractNamedRanges(formula) {
    var res = [], i;
 ...
 * @returns {*}
 */
export function extractImportRange(formula) {
    var res = [], i;
 ...
 * @returns {*}
 */
export function parseDate(/*string*/value, /*locale*/locale) {
 ...
 */
export function parseValue(/*any*/value, /*string*/locale) {
