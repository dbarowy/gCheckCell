 ...
 * @Description This module is used to construct the dependence tree and manipulate it.
 */
"use strict";
import ParserUtility = require("../Parser/ParserUtility");
 ...
 * @param app
 */
export function constructTree(/*AnalysisData*/analysisData, /*XApplication*/app) {
...
export function genGraph(/*AnalysisData*/data) {
 ...
 * @returns {Array}
 */
export function getFormulaRanges(/*XApplication*/app) {
 ...
 * @returns {*}
 */
export function createFormulaNodes(/*XRange[][]*/formulaRanges, /*XApplication*/app) {
 ...
 * @returns {null}
 */
export function makeRangeTreeNode(/*AnalysisData*/analysis, /*XRange*/range, /*TreeNode*/formula_node) {
