...
"use strict";
import Profiler = require("../Utilities/Profiler");
import HashMap = require("../Utilities/HashMap");
import InputSample = require("InputSample");
import BootMemo = require("BootMemo");
import FunctionOutput = require("FunctionOutput");
import TreeNode = require("TreeNode");

// Imported for type annotations.
import AnalysisData = require("AnalysisData");

/**
 * Propagate the weights
 * @param data
 */
function _propagateWeights(data : AnalysisData) {
...
function _propagateTreeNodeWeight(t : TreeNode) {
 ...
 */
export function storeInputs(inputs : TreeNode[]) {
 ...
 * @returns {*}
 */
export function storeOutputs(outputs : TreeNode[]) {
    var i, len;
 ...
 * @returns {Array}
 */
export function resample(num_bootstraps : number, orig_vals : InputSample) {
 ...
 * @returns {Array}
 */
export function init3DArray(fn_idx_sz : number, o_idx_sz : number, b_idx_sz : number) {
 ...
 * @returns {Array}
 */
export function computeBootstraps(num_bootstraps : number, /*HashMap<TreeNode, InputSample>*/initial_inputs, resamples : InputSample[][], input_arr : TreeNode[], output_arr : TreeNode[], data : AnalysisData) {
    var i, com, fos, b, t;
 ...
 * @returns {*}
 */
export function dictAdd(/*<TreeNode, int>*/d1, /*<TreeNode, int>*/d2) {
 ...
 * @returns {*}
 */
export function stringHypothesisTest(/*TreeNode*/ rangeNode, /*TreeNode*/ functionNode, /*FunctionOutput[]*/ boots, /*string*/ initial_output, /*bool*/ weighted) {
 ...
 * @constructor
 */
export function bootstrapFrequency(/*FunctionOutput<string>[]*/ boots) {
 ...
 * @returns {*}
 */
export function rejectNullHypothesis(/*FunctionOutput[]*/ boots, /* string*/ original_output, /*int*/ exclude_index) {
 ...
 * @returns {*}
 */
export function scoreInputs(/*TreeNode[]*/ input_rngs, /*TreeNode[]*/output_fns, /*<TreeNode, string>*/initial_outputs, /*FunctionOutput<string>[][][]*/ boots, /*bool*/ weighted, /*XApplication*/app) {
 ...
 * @constructor
 */
export function ColorOutliers(/*HashMap<TreeNode, int>*/input_exclusion_scores) {
 ...
 * @returns {boolean}
 */
export function functionOutputsAreNumeric(/*FunctionOutput[]*/boots) {
    var b;
 ...
 * @returns {*}
 */
export function convertToNumericOutput(/*FunctionOutput<string>[]*/boots) {
    var b;
    for (b = 0; b < boots.length; b++) {
 ...
 * @returns {*}
 */
export function numericHypothesisTest(/*TreeNode*/ rangeNode, /*TreeNode*/ functionNode, /* FunctionOutput[]*/ boots, /*string*/ initial_output, /*bool*/ weighted) {
 ...
 * @constructor
 */
export function Bootstrap(/*int*/num_bootstraps, /*AnalysisData*/data, /*XApplication*/app, /*Boolean*/weighted) {
